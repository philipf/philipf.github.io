...
WARNING: Although this configuration works well for DevTest purposes, it not recommended for production scenarios.
...
Still, it useful for DevTest at this price range, as the next SKU is about five times the price at ~$138.70 US/month.
